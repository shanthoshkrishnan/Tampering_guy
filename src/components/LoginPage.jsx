            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center cursor-pointer group">
                  ...
                  />
                  <span className={`ml-2 ${
                    isDarkMode ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-gray-800'
                  } transition`}>
                    Remember me
                  </span>
                </label>
  ...
  Forgot password?
            ...
            <div className={`mt-6 p-4 rounded-xl ${
              ...
              <div className="space-y-1">
                <p className={`text-xs text-center font-mono py-1 px-2 rounded ${
                  isDarkMode ? 'bg-gray-800/50 text-gray-300' : 'bg-white/50 text-gray-700'
                }`}>
                  👮 LM Officer: lmofficer@gmail.com / admin123
                </p>
                <p className={`text-xs text-center font-mono py-1 px-2 rounded ${
                  isDarkMode ? 'bg-gray-800/50 text-gray-300' : 'bg-white/50 text-gray-700'
                }`}>
                  👤 Consumer: raj.kumar@logistics.com / user123
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Footer text */}
          <p className={`text-center text-sm mt-6 flex items-center justify-center ${
